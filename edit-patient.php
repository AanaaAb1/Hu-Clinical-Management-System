...
$page_title = "Edit Patient - HU CMS";
...
if ($patient_id) {
    try {
        ...
        $error = "Error loading patient: " . $e->getMessage();
    }
} else {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $patient) {
    try {
        ...
        $sql = "UPDATE patients SET " . implode(', ', $setClause) . " WHERE id = :id";
        $data['id'] = $patient_id;
...
<head>
    ...
    <style>
        /* Same styles as register-patient.php */
        :root {
            --primary: #4361ee;
            --secondary: #3a0ca3;
            --success: #4cc9f0;
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-left">
                ...
                <p>Update patient details and medical information</p>
            </div>
                ...
                <div>
                    ...
                    <p style="opacity: 0.9; margin: 0;">
                        <?php 
                            ...
                            $now = new DateTime();
                            $age = $now->diff($dob)->y;
                            echo ucfirst($patient['gender']) . ', ' . $age . ' years old';
                        ?>
                    </p>
                </div>
                <div class="patient-id-badge">
                    <i class="fas fa-hashtag"></i> <?php echo htmlspecialchars($patient['patient_id']); ?>
                </div>
            </div>
                ...
                <form method="POST" action="" id="editPatientForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label class="form-label">
                                    <i class="fas fa-circle"></i> Patient Status
                                </label>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nationality" 
                                       value="<?php echo htmlspecialchars($patient['nationality'] ?? 'Ethiopian'); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="allergies" rows="3" 
                                          placeholder="List any allergies (e.g., Penicillin, Nuts, etc.)"><?php echo htmlspecialchars($patient['allergies'] ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="medical_history" rows="3" 
                                          placeholder="Previous medical conditions, surgeries, etc."><?php echo htmlspecialchars($patient['medical_history'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="religion">
                                    ...
                                    <option value="christian" <?php echo ($patient['religion'] ?? '') == 'christian' ? 'selected' : ''; ?>>Christian</option>
                                    <option value="muslim" <?php echo ($patient['religion'] ?? '') == 'muslim' ? 'selected' : ''; ?>>Muslim</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="language" 
                                       value="<?php echo htmlspecialchars($patient['language'] ?? 'Amharic'); ?>">
                            </div>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <div class="alert alert-danger" style="text-align: center;">
                ...
                <p>The requested patient does not exist or has been deleted.</p>
                <a href="patient-records.php" class="btn btn-primary" style="margin-top: 15px; width: auto;">
                    <i class="fas fa-arrow-left"></i> Back to Patient Records
                </a>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        if (editForm) {
            editForm.addEventListener('change', () => formChanged = true);
            editForm.addEventListener('input', () => formChanged = true);
